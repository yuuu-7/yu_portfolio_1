    ...
    <div className="absolute" style={{ 
      ...
      <button
        ...
        style={{
          ...
          `,
          // 边缘虚化效果 - 参考 smoothstep(0.1, 0.6, distorted) 的思路
          mask: isButtonTransitioning 
            ? 'none'
            : 'radial-gradient(circle, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 60%, rgba(0,0,0,0.8) 75%, rgba(0,0,0,0.4) 85%, rgba(0,0,0,0) 100%)',
          WebkitMask: isButtonTransitioning 
            ? 'none'
            : 'radial-gradient(circle, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 60%, rgba(0,0,0,0.8) 75%, rgba(0,0,0,0.4) 85%, rgba(0,0,0,0) 100%)',
          ...
          filter: isButtonTransitioning 
            ? 'blur(0px)' 
            : 'blur(1px) drop-shadow(0 0 8px rgba(251, 146, 60, 0.3))',
